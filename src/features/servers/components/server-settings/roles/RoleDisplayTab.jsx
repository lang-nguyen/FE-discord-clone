  ...
  return (
    <div className="space-y-8 max-w-[500px]">
       ...
       <div className="space-y-2">
         <label className="text-[12px] font-bold text-muted-text uppercase tracking-wide flex items-center">
           Role name <span className="text-[#da373c] ml-1 text-sm">*</span>
         </label>
         <input 
           value={role.name}
           onChange={(e) => onUpdate({ name: e.target.value })}
           className="w-full bg-server-sidebar-bg text-primary-text rounded p-2.5 text-[15px] border border-transparent focus:outline-none focus:border-blue-500"
         />
       </div>

       {/* Role Style */}
       <div className="space-y-2">
         <label className="text-[12px] font-bold text-muted-text uppercase tracking-wide">Role Style</label>
         <div className="flex items-center gap-3">
           {/* Solid */}
           <div className="p-[2px] rounded border-2 border-[#5865F2] cursor-pointer">
             <div className="bg-nav-sidebar-bg rounded flex flex-col items-center justify-center w-[120px] h-[80px] hover:bg-hover-bg">
               ...
               <div className="text-[12px] bg-chat-bg px-2 py-0.5 rounded font-medium text-primary-text/80">Solid</div>
             </div>
           </div>
           {/* Gradient/Holo mocking */}
           <div className="p-[2px] rounded border-2 border-transparent cursor-pointer opacity-40">
             <div className="bg-nav-sidebar-bg rounded flex flex-col items-center justify-center w-[120px] h-[80px]">
               <div className="flex items-center gap-1.5 mb-2">
               ...
               <div className="text-[12px] bg-chat-bg px-2 py-0.5 rounded font-medium text-primary-text/80">Gradient</div>
             </div>
           </div>
         </div>
         
         <div className="mt-2 bg-gradient-to-r from-[#2b2d31] to-[#232428] p-3 rounded-[8px] flex items-center justify-between border border-black/10 min-w-[500px]">
           <div className="text-sm">
             <span className="font-bold text-white text-[14px]">Make certain roles <span className="text-[#f47bbb]">magical</span></span>
             <p className="text-muted-text text-[12px]">Unlock new role styles with Boosting.</p>
           </div>
       ...
       {/* Role Color */}
       <div className="space-y-2">
         <div className="text-[12px] font-bold text-muted-text uppercase tracking-wide flex items-center">
           Role color <span className="text-[#da373c] ml-1 text-sm">*</span>
         </div>
         <p className="text-muted-text text-[13px]">Members use the color of the highest role they have on the roles list.</p>
         ...
         <div className="flex items-start gap-4 pt-2">
           <button className={`w-[70px] h-[55px] relative rounded-[4px] shrink-0 border-[3px] transition-colors ${role.color === '#99aab5' ? 'border-white bg-[#b5bac1]' : 'border-transparent bg-[#b5bac1] hover:bg-[#a8b1b8]'}`} onClick={() => onUpdate({ color: '#99aab5' })}>
             ...
             <div className="absolute -bottom-6 w-max left-1/2 -translate-x-1/2 text-[10px] text-muted-text font-bold">DEFAULT</div>
           </button>

           <div className="w-[70px] h-[55px] bg-server-sidebar-bg rounded-[4px] shrink-0 flex items-center justify-center cursor-pointer border hover:border-black transition-colors">
       ...
       <div className="space-y-3 pt-6">
         <div className="flex items-center gap-2">
           <div className="text-[12px] font-bold text-muted-text uppercase tracking-wide">Role icon</div>
           <div className="bg-nav-sidebar-bg text-[11px] font-bold text-gray-100 px-1.5 py-0.5 rounded-full flex items-center gap-1 border border-transparent shadow-[0_0_8px_rgba(244,123,187,0.15)]">
         ...
         <p className="text-muted-text text-[13px] leading-snug">
         ...
         <div className="flex items-start gap-4 mt-2">
           <div 
             className="w-[72px] h-[72px] bg-nav-sidebar-bg rounded-lg border-[2px] border-dashed border-[#4e5058] flex items-center justify-center cursor-pointer hover:border-gray-400 transition-colors overflow-hidden"
             onClick={() => fileInputRef.current?.click()}
           >
             {role.iconUrl ? (
               <img src={role.iconUrl} alt="Role Icon" className="w-full h-full object-cover" />
             ) : (
               <ImageIcon className="w-7 h-7 text-muted-text" />
             )}
           </div>
           <Button 
             variant="primary" 
       ...
       <div className="space-y-6">
          <div className="flex items-start justify-between">
            <div className="pr-4 text-[15px] font-medium text-primary-text leading-snug">
          ...
          <div className="flex items-start justify-between">
            <div className="pr-4">
              <h3 className="text-[15px] font-medium text-primary-text">Allow anyone to @mention this role</h3>
              <p className="text-muted-text text-[13px] mt-1 pr-6 leading-snug">
          ...
          <div className="pt-4">
            <h3 className="text-[12px] font-bold text-muted-text uppercase tracking-wide mb-1">View Server As Role</h3>
            <p className="text-muted-text text-[13px] mb-4">
