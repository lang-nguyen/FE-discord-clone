...
export const MemberRow = ({ member, onTransferOwnership, onBanMember, onChangeNickname }) => {
  return (
    <div className="grid grid-cols-[auto_1fr_120px_120px_120px_100px_100px_auto] items-center px-4 py-3 border-b border-[#3b3d44]/50 hover:bg-[#35373c] group transition-colors">
      ...
      <div className="flex items-center justify-end w-8">
        <MemberContextMenu member={member} onTransferOwnership={onTransferOwnership} onBanMember={onBanMember} onChangeNickname={onChangeNickname}>
