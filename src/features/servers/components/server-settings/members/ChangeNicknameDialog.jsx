      ...
      <DialogContent className="sm:max-w-[460px] bg-chat-bg text-primary-text border-none p-0 overflow-hidden gap-0 rounded-[8px] shadow-2xl">
        ...
        <div className="p-4 pt-2 space-y-4">
          ...
          <div className="space-y-2 pt-2">
            <label className="text-xs font-bold text-primary-text uppercase tracking-wide">
              Nickname
            </label>
            <input
              type="text"
              ...
              className="w-full bg-server-sidebar-bg border border-[#1e1f22] text-[15px] text-primary-text rounded-[4px] px-3 h-10 focus:outline-none focus:border-black/50 font-medium"
            />
          </div>
        </div>
        ...
        <div className="p-4 flex gap-3 mt-4 bg-nav-sidebar-bg">
          ...
          <Button 
            ...
            className="flex-1 text-white bg-[#5865F2] hover:bg-hover-bg h-[40px] rounded-[4px] font-medium transition-colors"
          >
            Save
          </Button>
        </div>
