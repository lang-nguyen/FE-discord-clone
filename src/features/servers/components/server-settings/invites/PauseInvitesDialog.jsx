        ...
        <div className="p-4 pt-4 space-y-4">
          <div className="relative">
            ...
            >
              ...
              <option value="2 hours" className="bg-[#2b2d31]">2 hours</option>
              <option value="24 hours" className="bg-[#2b2d31]">24 hours</option>
              <option value="Until I turn it back on" className="bg-[#2b2d31]">Until I turn it back on</option>
            </select>
            <ChevronDown className="w-5 h-5 text-gray-400 absolute right-3 top-[11px] pointer-events-none" />
          </div>

          <div className="bg-[#2b2d31] rounded-lg p-4 border border-[#1e1f22] flex items-start justify-between mt-4">
            <div className="pr-4">
              <h4 className="text-[15px] font-bold text-white mb-1">Pause Invites</h4>
              <p className="text-[13px] text-gray-300 leading-snug">Temporarily stop new members from joining this server via invite or vanity links.</p>
            </div>
            <button
              role="switch"
          ...
          <div className="bg-[#2b2d31] rounded-lg p-4 border border-[#1e1f22] flex items-start justify-between">
            <div className="pr-4">
              <h4 className="text-[15px] font-bold text-white mb-1">Pause DMs</h4>
              <p className="text-[13px] text-gray-300 leading-snug">Temporarily stop new direct messages from being sent between members in your server. Friends can still DM each other, moderators can still DM members, and your Apps can still DM members.</p>
            </div>
            <button
              role="switch"
